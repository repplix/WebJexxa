package io.jexxa.webjexxa.applicationservice;

import io.jexxa.addend.applicationcore.DomainService;
import io.jexxa.webjexxa.WebJexxa;
import io.jexxa.webjexxa.domain.book.BookNotInStockException;
...
import io.jexxa.webjexxa.domainservice.DomainEventSender;
...
import static io.jexxa.webjexxa.domain.book.BookSoldOut.bookSoldOut;
...
class BookStoreServiceTest
{
    ...
    void initTest()
    {
        ...
        JexxaTest jexxaTest = getJexxaTest(WebJexxa.class);
