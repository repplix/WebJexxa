package io.jexxa.webjexxa.integration;
...
class WebJexxaIT
{
    ...
    void initBeforeEach()
    {
        var jexxaTest = getJexxaTest(WebJexxa.class);
        ...
        await().atMost(10, TimeUnit.SECONDS)
                ...
                .until(WebJexxaIT::contextIsRunning);
    ...
    void testStartupApplication()
    {
        ...
        //Assert
        assertEquals(WebJexxa.class.getSimpleName(), result);
    }
